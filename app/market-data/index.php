...
<head>
    ...
    <style>
        ...
        .md-watchlist-empty { display:none; } /* Handled by HTML empty state */
...
<div class="dashboard-container">
    ...
    <aside class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="menu-item active" <?php echo !rich_feature_enabled('market-data', true, $user_id) ? 'style="opacity: 0.5;"' : ''; ?> onclick="window.location.href='../market-data'">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="md-pane active" id="tab-feeds">
            ...
            <div class="md-chart-wrap" style="display:flex; flex-direction:row; background:#0f0f0f; padding:0;">
                ...
                <div class="md-watchlist-sidebar" id="mdWatchlistSidebar" style="width:250px; flex-shrink:0; border-left:1px solid #1e1e1e; display:flex; flex-direction:column; transition: width 0.3s ease; overflow:hidden;">
                    <div class="md-watchlist-heading" style="padding:10px 16px; border-bottom:1px solid #1e1e1e; display:flex; justify-content:space-between; align-items:center; min-width:250px; height:39px; box-sizing:border-box;">
                ...
                <!-- Toolstrip -->
                <div class="md-chart-toolstrip" style="width:40px; flex-shrink:0; border-left:1px solid #1e1e1e; display:flex; flex-direction:column; align-items:center; padding-top:2px; gap:12px;">
...
async function initChart() {
    ...
    for (let i = 1; i <= cellCount; i++) {
        ...
        disabled_features: ['use_localstorage_for_settings','header_interval_dialog_button','header_resolutions','create_volume_indicator_by_default'].concat(i > 1 ? ['left_toolbar', 'header_widget'] : []),
