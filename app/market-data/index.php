        ...
        <div class="md-pane active" id="tab-feeds">
            ...
            <div class="md-chart-wrap" style="display:flex; flex-direction:row; background:#0f0f0f; padding:0;">
                ...
                <div class="md-watchlist-sidebar" id="mdWatchlistSidebar" style="width:250px; flex-shrink:0; border-left:1px solid #1e1e1e; display:flex; flex-direction:column; transition: width 0.3s ease; overflow:hidden;">
                    <div class="md-watchlist-heading" style="padding:12px 16px; border-bottom:1px solid #1e1e1e; display:flex; justify-content:space-between; align-items:center; min-width:250px;">
                ...
                <!-- Toolstrip -->
                <div class="md-chart-toolstrip" style="width:40px; flex-shrink:0; border-left:1px solid #1e1e1e; display:flex; flex-direction:column; align-items:center; padding-top:8px; gap:12px;">
