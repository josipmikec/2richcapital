...
$back_url = $journal_id > 0
    ? '/journal/view?id=' . $trade_id . '&journal_id=' . $journal_id
    : '/journal/view?id=' . $trade_id;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Edit Trade - 2RICH CAPITAL</title>
...
<body>
        ...
        <main class="main-content">
            <div class="form-header">
                <div>
                    ...
                    <h2 class="page-title">Edit Trade</h2>
            ...
            <form id="tradeForm" class="trade-form" style="display: none;">
                <input type="hidden" name="trade_id" id="trade_id" value="<?php echo $trade_id; ?>">
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label for="profit_loss" class="label-with-tooltip">
                                P&amp;L ($)
                ...
                <!-- SECTION 7: CUSTOM COLUMNS (dynamic — shown only if user has custom columns) -->
    ...
    <script src="../../assets/js/trade-edit.js"></script>
</body>
</html>
