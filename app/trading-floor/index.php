...
<head>
    ...
    <style>
        ...
        .profile-profile-actions { display:flex; gap:10px; margin-top:16px; flex-wrap:nowrap; width:100%; max-width:250px; margin-left:0; margin-right:0; justify-content:flex-start; }
