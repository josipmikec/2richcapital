...
<!-- Middle Feed -->
    ...
    function renderFeedPostModal(post) {
        ...
        title.innerHTML = `<span style="font-weight:600;">${authorName}</span>${groupBadge}`;
