...
<head>
    ...
    <style>
        ...
        .group-feed-top { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; margin-inline: 18px; }
        ...
        .group-feed-body { margin: 10px 18px 0; font-size: 13px; line-height: 1.55; color: #d3d3d3; }
