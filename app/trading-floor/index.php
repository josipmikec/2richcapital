...
<head>
    ...
    <style>
        ...
        .profile-profile-actions { display:flex; gap:12px; margin-top:16px; flex-wrap:wrap; width:min(100%, 88px); margin-left:auto; margin-right:auto; }
        .profile-action-btn { flex:1 1 0; display:inline-flex; align-items:center; justify-content:center; min-width:0; padding:10px 10px; border-radius:999px; border:1px solid rgba(255,255,255,0.05); background:#131313; color:#bfc3ca; font-size:10px; font-weight:700; letter-spacing:0.01em; text-transform:none; transition:background 0.2s,border-color 0.2s,color 0.2s,transform 0.2s; }
