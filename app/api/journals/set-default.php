...
$wpdb->update(
    $table,
    ['is_default' => 0, 'updated_at' => current_time('mysql')],
    ['user_id' => $user_id],
    ['%d', '%s'],
    ['%d']
);
...
if ($updated === false) {
    ...
    echo json_encode(['success' => false, 'message' => 'Failed to update default journal']);
    exit;
}

echo json_encode([
    'success' => true,
    'message' => 'Default journal updated successfully'
]);
