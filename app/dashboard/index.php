...
<body>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            <ul class="sidebar-menu">
                <li class="menu-item active" <?php echo !rich_feature_enabled('dashboard', true, $user_id) ? 'style="opacity: 0.5;"' : ''; ?> onclick="window.location.href='/dashboard'">
            ...
            <div class="widget-grid" id="widgetGrid">
                ...
                <div class="widget widget-chat" data-card-id="chat" style="position:relative;">
                    ...
                    <div class="widget-body" id="chat-pane">
                        ...
                        <div id="dashboardGroupChatFooter" class="dashboard-group-chat-footer" style="position:relative;" hidden>
                ...
                <div class="widget widget-journal" data-card-id="journal" style="position:relative;">
                    ...
                    <div class="widget-body" id="journal-pane">
                        <div class="dashboard-journal-card" id="dashboardJournalCard">
                            ...
                            <div class="dashboard-journal-divider" aria-hidden="true"></div>
                            <div class="dashboard-journal-curve-head">
    ...
    (function () {
        ...
        const loadJournalCard = async () => {
            ...
            try {
                ...
                setText('dashboardJournalTotalTrades', stats.total_trades ?? 0);
                setText('dashboardJournalWinRate', `${stats.win_rate ?? 0}%`);
                const average = Number(stats.avg_profit_loss_pct ?? 0);
                setText('dashboardJournalAvgPL', `${average >= 0 ? '+' : ''}${average}%`);
    ...
    (function () {
        ...
        async function selectGroup(id) {
            ...
            composer.style.display = ''; setCta('Visit Group', `/trading-floor#groups&group=${encodeURIComponent(String(group.id))}`, true);
            await loadMessages();
        }
        async function init() {
